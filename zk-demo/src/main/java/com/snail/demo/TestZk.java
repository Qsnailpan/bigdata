...
/**
 * @author lipan 2019年1月2日
 * @description （ 简单的描述 下：zookeeper 实现秒杀 ）
 *
 */
public class TestZk {
	...
	public static void main(String[] args) {
		...
		/*
		 * 1000: 每次等待的时间 10:重试的次数
		 */
		RetryPolicy policy = new ExponentialBackoffRetry(1000, 10);

		// 创建一个ZK的客户端
		CuratorFramework cf = CuratorFrameworkFactory.builder().connectString("192.168.112.10:2181") // ZK的地址
